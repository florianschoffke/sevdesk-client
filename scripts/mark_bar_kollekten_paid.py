...
class BarKollektenMarker:
    ...
    def run(self, mark_single: bool = False, mark_all: bool = False, generate_report: bool = True):
        ...
        if not mark_single and not mark_all:
            ...
            print("  - Test with single voucher: python3 scripts/mark_bar_kollekten_paid.py --mark-single")
            print("  - Mark all vouchers:        python3 scripts/mark_bar_kollekten_paid.py --mark-all")
            print()
            return
